...
from datagouvfr_data_pipelines.data_processing.uai.task_functions import (
...
TMP_FOLDER = f"{AIRFLOW_DAG_TMP}uai/"
...
with DAG(
    ...
    process_uai = PythonOperator(
        task_id="process_uai", python_callable=process_uai
    )
