...
addok_ban = [
    "http://localhost:7878/search/",
    "http://localhost:7879/search/",
    "http://localhost:7880/search/",
    "http://localhost:7881/search/",
    "http://localhost:7882/search/",
    "http://localhost:7883/search/",
]
...
for commune in communes:
    commune_insee[commune["\ufeffinsee"]] = {
        "lat": round(float(commune["lon_centro"]), 6),
            ...
            if source is None:
                ...
                # Centres commerciaux...
                    ...
                    poi = geocode(
                        addok_poi,
                        {
                            "q": re.sub(ccial, "\1 Galerie Marchande", libvoie),
                            "poi": "mall",
                            "citycode": depcom,
                            "limit": "1",
                        },
