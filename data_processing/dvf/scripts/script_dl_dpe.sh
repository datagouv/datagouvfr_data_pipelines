...
cd $DATADIR/dpe/01
unzip 01.csv.zip
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/01/01.csv.zip && rm -rf $DATADIR/dpe/01/csv && $DATADIR/dpe/01/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/02/02.csv.zip && rm -rf $DATADIR/dpe/02/csv && $DATADIR/dpe/02/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/03/03.csv.zip && rm -rf $DATADIR/dpe/03/csv && $DATADIR/dpe/03/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/04/04.csv.zip && rm -rf $DATADIR/dpe/04/csv && $DATADIR/dpe/04/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/05/05.csv.zip && rm -rf $DATADIR/dpe/05/csv && $DATADIR/dpe/05/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/06/06.csv.zip && rm -rf $DATADIR/dpe/06/csv && $DATADIR/dpe/06/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/07/07.csv.zip && rm -rf $DATADIR/dpe/07/csv && $DATADIR/dpe/07/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/08/08.csv.zip && rm -rf $DATADIR/dpe/08/csv && $DATADIR/dpe/08/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/09/09.csv.zip && rm -rf $DATADIR/dpe/09/csv && $DATADIR/dpe/09/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/10/10.csv.zip && rm -rf $DATADIR/dpe/10/csv && $DATADIR/dpe/10/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/11/11.csv.zip && rm -rf $DATADIR/dpe/11/csv && $DATADIR/dpe/11/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/12/12.csv.zip && rm -rf $DATADIR/dpe/12/csv && $DATADIR/dpe/12/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/13/13.csv.zip && rm -rf $DATADIR/dpe/13/csv && $DATADIR/dpe/13/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/14/14.csv.zip && rm -rf $DATADIR/dpe/14/csv && $DATADIR/dpe/14/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/15/15.csv.zip && rm -rf $DATADIR/dpe/15/csv && $DATADIR/dpe/15/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/16/16.csv.zip && rm -rf $DATADIR/dpe/16/csv && $DATADIR/dpe/16/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/17/17.csv.zip && rm -rf $DATADIR/dpe/17/csv && $DATADIR/dpe/17/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/18/18.csv.zip && rm -rf $DATADIR/dpe/18/csv && $DATADIR/dpe/18/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/19/19.csv.zip && rm -rf $DATADIR/dpe/19/csv && $DATADIR/dpe/19/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/21/21.csv.zip && rm -rf $DATADIR/dpe/21/csv && $DATADIR/dpe/21/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/22/22.csv.zip && rm -rf $DATADIR/dpe/22/csv && $DATADIR/dpe/22/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/23/23.csv.zip && rm -rf $DATADIR/dpe/23/csv && $DATADIR/dpe/23/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/24/24.csv.zip && rm -rf $DATADIR/dpe/24/csv && $DATADIR/dpe/24/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/25/25.csv.zip && rm -rf $DATADIR/dpe/25/csv && $DATADIR/dpe/25/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/26/26.csv.zip && rm -rf $DATADIR/dpe/26/csv && $DATADIR/dpe/26/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/27/27.csv.zip && rm -rf $DATADIR/dpe/27/csv && $DATADIR/dpe/27/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/28/28.csv.zip && rm -rf $DATADIR/dpe/28/csv && $DATADIR/dpe/28/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/29/29.csv.zip && rm -rf $DATADIR/dpe/29/csv && $DATADIR/dpe/29/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/2a/2a.csv.zip && rm -rf $DATADIR/dpe/2a/csv && $DATADIR/dpe/2a/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/2b/2b.csv.zip && rm -rf $DATADIR/dpe/2b/csv && $DATADIR/dpe/2b/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/30/30.csv.zip && rm -rf $DATADIR/dpe/30/csv && $DATADIR/dpe/30/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/31/31.csv.zip && rm -rf $DATADIR/dpe/31/csv && $DATADIR/dpe/31/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/32/32.csv.zip && rm -rf $DATADIR/dpe/32/csv && $DATADIR/dpe/32/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/33/33.csv.zip && rm -rf $DATADIR/dpe/33/csv && $DATADIR/dpe/33/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/34/34.csv.zip && rm -rf $DATADIR/dpe/34/csv && $DATADIR/dpe/34/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/35/35.csv.zip && rm -rf $DATADIR/dpe/35/csv && $DATADIR/dpe/35/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/36/36.csv.zip && rm -rf $DATADIR/dpe/36/csv && $DATADIR/dpe/36/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/37/37.csv.zip && rm -rf $DATADIR/dpe/37/csv && $DATADIR/dpe/37/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/38/38.csv.zip && rm -rf $DATADIR/dpe/38/csv && $DATADIR/dpe/38/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/39/39.csv.zip && rm -rf $DATADIR/dpe/39/csv && $DATADIR/dpe/39/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/40/40.csv.zip && rm -rf $DATADIR/dpe/40/csv && $DATADIR/dpe/40/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/41/41.csv.zip && rm -rf $DATADIR/dpe/41/csv && $DATADIR/dpe/41/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/42/42.csv.zip && rm -rf $DATADIR/dpe/42/csv && $DATADIR/dpe/42/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/43/43.csv.zip && rm -rf $DATADIR/dpe/43/csv && $DATADIR/dpe/43/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/44/44.csv.zip && rm -rf $DATADIR/dpe/44/csv && $DATADIR/dpe/44/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/45/45.csv.zip && rm -rf $DATADIR/dpe/45/csv && $DATADIR/dpe/45/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/46/46.csv.zip && rm -rf $DATADIR/dpe/46/csv && $DATADIR/dpe/46/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/47/47.csv.zip && rm -rf $DATADIR/dpe/47/csv && $DATADIR/dpe/47/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/48/48.csv.zip && rm -rf $DATADIR/dpe/48/csv && $DATADIR/dpe/48/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/49/49.csv.zip && rm -rf $DATADIR/dpe/49/csv && $DATADIR/dpe/49/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/50/50.csv.zip && rm -rf $DATADIR/dpe/50/csv && $DATADIR/dpe/50/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/51/51.csv.zip && rm -rf $DATADIR/dpe/51/csv && $DATADIR/dpe/51/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/52/52.csv.zip && rm -rf $DATADIR/dpe/52/csv && $DATADIR/dpe/52/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/53/53.csv.zip && rm -rf $DATADIR/dpe/53/csv && $DATADIR/dpe/53/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/54/54.csv.zip && rm -rf $DATADIR/dpe/54/csv && $DATADIR/dpe/54/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/55/55.csv.zip && rm -rf $DATADIR/dpe/55/csv && $DATADIR/dpe/55/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/56/56.csv.zip && rm -rf $DATADIR/dpe/56/csv && $DATADIR/dpe/56/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/57/57.csv.zip && rm -rf $DATADIR/dpe/57/csv && $DATADIR/dpe/57/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/58/58.csv.zip && rm -rf $DATADIR/dpe/58/csv && $DATADIR/dpe/58/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/59/59.csv.zip && rm -rf $DATADIR/dpe/59/csv && $DATADIR/dpe/59/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/60/60.csv.zip && rm -rf $DATADIR/dpe/60/csv && $DATADIR/dpe/60/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/61/61.csv.zip && rm -rf $DATADIR/dpe/61/csv && $DATADIR/dpe/61/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/62/62.csv.zip && rm -rf $DATADIR/dpe/62/csv && $DATADIR/dpe/62/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/63/63.csv.zip && rm -rf $DATADIR/dpe/63/csv && $DATADIR/dpe/63/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/64/64.csv.zip && rm -rf $DATADIR/dpe/64/csv && $DATADIR/dpe/64/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/65/65.csv.zip && rm -rf $DATADIR/dpe/65/csv && $DATADIR/dpe/65/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/66/66.csv.zip && rm -rf $DATADIR/dpe/66/csv && $DATADIR/dpe/66/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/67/67.csv.zip && rm -rf $DATADIR/dpe/67/csv && $DATADIR/dpe/67/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/68/68.csv.zip && rm -rf $DATADIR/dpe/68/csv && $DATADIR/dpe/68/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/69/69.csv.zip && rm -rf $DATADIR/dpe/69/csv && $DATADIR/dpe/69/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/70/70.csv.zip && rm -rf $DATADIR/dpe/70/csv && $DATADIR/dpe/70/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/71/71.csv.zip && rm -rf $DATADIR/dpe/71/csv && $DATADIR/dpe/71/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/72/72.csv.zip && rm -rf $DATADIR/dpe/72/csv && $DATADIR/dpe/72/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/73/73.csv.zip && rm -rf $DATADIR/dpe/73/csv && $DATADIR/dpe/73/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/74/74.csv.zip && rm -rf $DATADIR/dpe/74/csv && $DATADIR/dpe/74/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/75/75.csv.zip && rm -rf $DATADIR/dpe/75/csv && $DATADIR/dpe/75/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/76/76.csv.zip && rm -rf $DATADIR/dpe/76/csv && $DATADIR/dpe/76/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/77/77.csv.zip && rm -rf $DATADIR/dpe/77/csv && $DATADIR/dpe/77/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/78/78.csv.zip && rm -rf $DATADIR/dpe/78/csv && $DATADIR/dpe/78/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/79/79.csv.zip && rm -rf $DATADIR/dpe/79/csv && $DATADIR/dpe/79/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/80/80.csv.zip && rm -rf $DATADIR/dpe/80/csv && $DATADIR/dpe/80/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/81/81.csv.zip && rm -rf $DATADIR/dpe/81/csv && $DATADIR/dpe/81/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/82/82.csv.zip && rm -rf $DATADIR/dpe/82/csv && $DATADIR/dpe/82/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/83/83.csv.zip && rm -rf $DATADIR/dpe/83/csv && $DATADIR/dpe/83/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/84/84.csv.zip && rm -rf $DATADIR/dpe/84/csv && $DATADIR/dpe/84/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/85/85.csv.zip && rm -rf $DATADIR/dpe/85/csv && $DATADIR/dpe/85/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/86/86.csv.zip && rm -rf $DATADIR/dpe/86/csv && $DATADIR/dpe/86/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/87/87.csv.zip && rm -rf $DATADIR/dpe/87/csv && $DATADIR/dpe/87/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/88/88.csv.zip && rm -rf $DATADIR/dpe/88/csv && $DATADIR/dpe/88/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/89/89.csv.zip && rm -rf $DATADIR/dpe/89/csv && $DATADIR/dpe/89/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/90/90.csv.zip && rm -rf $DATADIR/dpe/90/csv && $DATADIR/dpe/90/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/91/91.csv.zip && rm -rf $DATADIR/dpe/91/csv && $DATADIR/dpe/91/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/92/92.csv.zip && rm -rf $DATADIR/dpe/92/csv && $DATADIR/dpe/92/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/93/93.csv.zip && rm -rf $DATADIR/dpe/93/csv && $DATADIR/dpe/93/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/94/94.csv.zip && rm -rf $DATADIR/dpe/94/csv && $DATADIR/dpe/94/doc
...
cp csv/rel_batiment_groupe_parcelle.csv .
cp csv/batiment_groupe_dpe_representatif_logement.csv .
rm -rf $DATADIR/dpe/95/95.csv.zip && rm -rf $DATADIR/dpe/95/csv && $DATADIR/dpe/95/doc