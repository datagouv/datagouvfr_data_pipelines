...
code_insee_commune_1 VARCHAR(100),
prefixe_1 VARCHAR(10),
section_1 VARCHAR(2),
numero_parcelle_1 VARCHAR(5),
reference_cadastrale_2 VARCHAR(14),
code_insee_commune_2 VARCHAR(100),
prefixe_2 VARCHAR(10),
section_2 VARCHAR(2),
numero_parcelle_2 VARCHAR(5),
reference_cadastrale_3 VARCHAR(14),
code_insee_commune_3 VARCHAR(100),
prefixe_3 VARCHAR(10),
section_3 VARCHAR(2),
numero_parcelle_3 VARCHAR(5),
