...
curl -o $DATADIR/2022_pres_t2.txt $URL_2022_pres_t1 -L
curl -o $DATADIR/2022_legi_t1.txt $URL_2022_pres_t1 -L
curl -o $DATADIR/2022_legi_t2.txt $URL_2022_pres_t1 -L
