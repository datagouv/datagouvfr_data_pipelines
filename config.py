...
MATTERMOST_DATAGOUV_SCHEMA_ACTIVITE = Variable.get("MATTERMOST_DATAGOUV_SCHEMA_ACTIVITE")
...
SECRET_MAIL_DATAGOUV_BOT_RECIPIENTS_PROD = Variable.get("SECRET_MAIL_DATAGOUV_BOT_RECIPIENTS_PROD").split(',')